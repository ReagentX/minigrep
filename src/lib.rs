...
atlas";
        ...
        assert_eq!(vec!["1: abicus", "2: anteater", "3: atlas"], search(contents, query));
    }
...
Pick three.";
        ...
        assert_eq!(vec!["2: safe, fast, productive."], search_case_insensitive(contents, query));
    }
...
atlas";
        ...
        assert_eq!(vec!["1: abicus", "2: anteater", "3: atlas"], search_case_insensitive(contents, query));
    }
}
